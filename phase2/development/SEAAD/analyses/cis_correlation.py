...
def main():
    ...
    log_filename = f"{logs_dir}/all_celltypes_{args.endo_modality}_{args.exog_modality}_{args.regression_type}_{args.target_variable}_cis_correlation.log"
    logging.basicConfig(
    ...
    exog_results_file = (
        results_dir
        / f"{args.project}.all_celltypes.{args.exog_modality}.{args.regression_type}.{args.target_variable}.csv"
    )
    ...
    sig_out_file = (
        results_dir
        / f"{args.project}.{args.endo_modality}-{args.exog_modality}.all_celltypes.{args.regression_type}.{args.target_variable}.cis.fdr_filtered.csv"
    )
